...
$$" style="border:none;">
https://latex.codecogs.com/gif.latex?\\\mu=\frac{1}{m}\Sigma_{i=1}^mx_i\\\sigma^2=\frac{\Sigma_{i=1}^m(x_i-\mu)^2}{m}\\\hat{x}_i=\frac{x_i-\mu}{\sqrt{\sigma^2+\epsilon}}\\y_i=\gamma\hat{x}_i+\beta
